...
class RaceScore:
    ...
    race_num: int
    points: int
    penalty: str | None = None  # e.g. "DNF", "DSQ", "DNS", "BYE"
    penalty_formula: str | None = None  # e.g. "Fleet + 1", "average in division"
    penalty_comment: str | None = None  # free-text RC comment, e.g. "crew overboard"
...
class DivisionResult:
    ...
    rank: int | None = None  # per-division rank from /<season>/<slug>/<div>/ page
