...
PAGE = (
    ...
    + _row("/s26/hood/", "Hood Trophy", "MIT", "2026-05-21", "May 21", "Skipper",
           '<a href="/s26/hood/A/">2/18 (A Div)</a>')
    + _row("/f25/match-cup/", "Match Cup", "Navy", "2025-11-15", "Nov 15", "Skipper",
           '<a href="/f25/match-cup/full-scores/#team-3">1/10</a>')      # no division
    + _row("/s25/twinstate/", "Twin State", "Dartmouth", "2025-04-12", "Apr 12", "Skipper, Crew",
           '<a href="/s25/twinstate/A/">3/18 (A Div)</a>'
           '<a href="/s25/twinstate/B/">5/18 (B Div)</a>')                # two divisions
